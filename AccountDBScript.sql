...
/****** Object:  Database [AccountDB]    Script Date: 21-09-2019 21:14:07 ******/
CREATE DATABASE [AccountDB]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'AccountDB', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL13.MSSQLSERVER\MSSQL\DATA\AccountDB.mdf' , SIZE = 8192KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'AccountDB_log', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL13.MSSQLSERVER\MSSQL\DATA\AccountDB_log.ldf' , SIZE = 8192KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB )
GO

ALTER DATABASE [AccountDB] SET COMPATIBILITY_LEVEL = 130
GO
